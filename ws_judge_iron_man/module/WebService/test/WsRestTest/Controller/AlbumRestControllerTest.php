<?php
namespace WsRestTest\Controller;
 
use WsRestTest\Bootstrap;
use WsRest\Controller\AlbumRestController;
...
class AlbumRestControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Api\Model\AlbumTable', $this->controller->getAlbumTable());
    }
}
