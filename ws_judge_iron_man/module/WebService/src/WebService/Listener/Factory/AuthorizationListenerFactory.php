...
use WebService\Listener\AuthorizationListener;
...
class AuthorizationListenerFactory implements FactoryInterface
{
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $authorizationConfiguration = 
            array_key_exists('prestor_authorization', $configuration)
            ? $configuration['prestor_authorization']
            : [];
        return new AuthorizationListener($authorizationConfiguration);
    }
}