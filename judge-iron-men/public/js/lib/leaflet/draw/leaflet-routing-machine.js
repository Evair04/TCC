    ...
    "v5": {
        "constants": {
            ...
            "modifier": {
                ...
                "slight left": "curva ligeira à esquerda",
                "slight right": "curva ligeira à direita",
                "straight": "em frente",
                "uturn": "Meia volta"
            },
            "lanes": {
                "xo": "Mantenha-se a direita",
                "ox": "Mantenha-se a esquerda",
                "xox": "Mantenha-se no meio",
                "oxo": "Mantenha-se à direita ou esquerda"
            }
        },
        "modes": {
            "ferry": {
                ...
                "destination": "Pegue a balsa para {destination}"
            }
        },
        "arrive": {
            "default": {
                "default": "Você chegou ao {nth} destino"
            },
            "left": {
                "default": "Você chegou ao {nth} destino, à esquerda"
            },
            "right": {
                "default": "Você chegou ao {nth} destino, à direita"
            },
            "sharp left": {
                "default": "Você chegou ao {nth} destino, à esquerda"
            },
            ...
            "straight": {
                "default": "Você chegou ao {nth} destino, em frente"
            }
        },
        "continue": {
            "default": {
                "default": "Continue {modifier}",
                "name": "Continue {modifier} na {way_name}",
                "destination": "Continue {modifier} em direção à {destination}"
            },
            "straight": {
                "default": "Continue reto",
                "name": "Continue na {way_name}",
                "destination": "Continue em direção à {destination}"
            },
            "slight left": {
                "default": "Continue ligeiramente à esquerda",
                "name": "Continue ligeiramente à esquerda na {way_name}",
                "destination": "Continue ligeiramente à esquerda em direção à {destination}"
            },
            "slight right": {
                "default": "Continue ligeiramente à direita",
                "name": "Continue ligeiramente à direita na {way_name}",
                "destination": "Continue ligeiramente à direita em direção à {destination}"
            },
            "uturn": {
                "default": "Faça meia volta",
                "name": "Faça meia volta na {way_name}",
                "destination": "Faça meia volta em direção à {destination}"
            }
        },
        "depart": {
            "default": {
                "default": "Siga {direction}",
                "name": "Siga {direction} na {way_name}"
            }
        },
        "end of road": {
            "default": {
                "default": "Vire {modifier}",
                "name": "Vire {modifier} na {way_name}",
                "destination": "Vira {modifier} em direção à {destination}"
            },
            "straight": {
                "default": "Continue reto",
                "name": "Continue reto na {way_name}",
                "destination": "Continue reto em direção à {destination}"
            },
            "uturn": {
                "default": "Faça meia volta no fim da rua",
                "name": "Faça meia volta na {way_name} no fim da rua",
                "destination": "Faça meia volta em direção à {destination} no fim da rua"
            }
        },
        "fork": {
            "default": {
                "default": "Mantenha-se {modifier} na bifurcação",
                "name": "Mantenha-se {modifier} na bifurcação para {way_name}",
                "destination": "Mantenha-se {modifier} na encruzilhada em direção à {destination}"
            },
            "slight left": {
                "default": "Mantenha-se à esquerda na bifurcação",
                "name": "Mantenha-se à esquerda na bifurcação na {way_name}",
                "destination": "Mantenha-se à esquerda na bifurcação em direção à {destination}"
            },
            "slight right": {
                "default": "Mantenha-se à direita na bifurcação",
                "name": "Mantenha-se à direita na bifurcação na {way_name}",
                "destination": "Mantenha-se à direita na bifurcação em direção à {destination}"
            },
            "sharp left": {
                "default": "Faça curva acentuada à esquerda na bifurcação",
                "name": "faça curva acentuada à esquerda na bifurcação na {way_name}",
                "destination": "faça curva acentuada à esquerda na bifurcação em direção à {destination}"
            },
            "sharp right": {
                "default": "Faça curva acentuada à direita na bifurcação",
                "name": "faça curva acentuada à direita na bifurcação na {way_name}",
                "destination": "faça curva acentuada à direita na bifurcação em direção à {destination}"
            },
            "uturn": {
                "default": "Dê meia volta",
                "name": "Dê meia volta na {way_name}",
                "destination": "Dê meia volta em direção à {destination}"
            }
        },
        "merge": {
            "default": {
            ...
            "sharp right": {
                "default": "Entre à direita",
                "name": "Entre à direita na {way_name}",
                "destination": "Entre `Pa direita em direção à {destination}"
            },
            "uturn": {
                "default": "Faça meia volta",
                "name": "Faça meia volta na {way_name}",
        ...
        "new name": {
            ...
            "sharp left": {
                "default": "Faça uma curva acentuada à esquerda",
                "name": "Faça uma curva acentuada à esquerda na {way_name}",
                "destination": "Faça uma curva acentuada à esquerda em direção à {destination}"
            },
            "sharp right": {
                "default": "Faça uma curva acentuada à direita",
                "name": "Faça uma curva acentuada à direita na {way_name}",
                "destination": "Faça uma curva acentuada à direita em direção à {destination}"
            },
            "slight left": {
                "default": "Continue ligeiramente à esquerda",
                "name": "Continue ligeiramente à esquerda na {way_name}",
        ...
        "rotary": {
            "default": {
                ...
                "name": {
                    ...
                    "name": "Entre na {rotary_name} e saia na {way_name}",
                ...
                "name_exit": {
                    "default": "Entre na {rotary_name} e pegue a {exit_number} saída",
                    "name": "Entre na {rotary_name} e pegue a {exit_number} saída na {way_name}",
        ...
        "roundabout": {
            "default": {
                "exit": {
                    "default": "Entre na rótula e pegue a {exit_number} saída",
                    "name": "Entre na rótula e pegue a {exit_number} saída na {way_name}",
                    "destination": "Entre na rótula e pegue a {exit_number} saída em direção à {destination}"
                },
                "default": {
                    "default": "Entre na rótula",
                    "name": "Entre na rótula e saia na {way_name}",
                    "destination": "Entre na rótula e saia em direção à {destination}"
                }
            }
        },
        "roundabout turn": {
            "default": {
                "default": "Na rótula vire {modifier}",
                "name": "Na rótula vire {modifier} na {way_name}",
                "destination": "Na rótula vire {modifier} em direção à {destination}"
            },
            "left": {
                "default": "Na rótula vire à esquerda",
                "name": "Na rótula vire à esquerda na {way_name}",
                "destination": "Na rótula vire à esquerda em direção à {destination}"
            },
            "right": {
                "default": "Na rótula vire à direita",
                "name": "Na rótula vire à direita na {way_name}",
                "destination": "Na rótula vire à direita em direção à {destination}"
            },
            "straight": {
                "default": "Na rótula continue reto",
                "name": "Na rótula continue reto na {way_name}",
                "destination": "Na rótula continue reto em direção à {destination}"
            }
        },
        "turn": {
            "default": {
                "default": "Vire {modifier}",
                "name": "Vire {modifier} na {way_name}",
                "destination": "Vire {modifier} em direção à {destination}"
            },
            "left": {
                "default": "Vire à esquerda",
                "name": "Vire à esquerda na {way_name}",
                "destination": "Vire à esquerda em direção à {destination}"
            },
            "right": {
                "default": "Vire à direita",
                "name": "Vire à direita na {way_name}",
                "destination": "Vire à direita em direção à {destination}"
            },
            "straight": {
                "default": "Vá reto",
                "name": "Vá reto na {way_name}",
                "destination": "Vá reto em direção à {destination}"
            }
        },
        "use lane": {
            "no_lanes": {
	...
	module.exports = L.extend(Localization, {
		'en': {
			...
			instructions: {
				...
				'OffRamp': ['Pegue a rampa on the {modifier}', ' onto {road}'],
