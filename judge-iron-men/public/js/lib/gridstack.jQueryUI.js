...
(function(factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'lodash', 'public/js/lib/gridstack', 'jquery-ui/data', 'jquery-ui/disable-selection', 'jquery-ui/focusable',
        ...
        try { GridStackUI = require('public/js/lib/gridstack'); } catch (e) {}
